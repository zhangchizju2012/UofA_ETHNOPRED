...
#time ./ethnopred_once -i cpp_code/csv/test_rev_European.csv -t ${snip_path} -s ${selected_snip_path} -T ${classifier_type}
#time ./ethnopred -i cpp_code/csv/test.csv -t ${snip_path} -s ${selected_snip_path} -T ${classifier_type}
time ./ethnopred_once -i cpp_code/csv/East_asian_used.csv -t ${snip_path} -s ${selected_snip_path} -T ${classifier_type}
